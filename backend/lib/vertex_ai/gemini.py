...
- Pick a **short, expressive title** that captures the spirit of the whole book in connection with the context in user instruction.
...
Requirements:
- When appropriate, occasionally thread the gift context and elements from the user instructions into the page message. Never be repetitive and robotic.
...
* **Style constraints:**
    ...
    - Keep it heartfelt but grounded.
        ...
        if user_provided_gift_recipient:
            ...
            parts.append(
                types.Part.from_text(
                    text="  This is a gift for " + user_provided_gift_recipient
                )
            )
            parts.append(types.Part.from_text(text="</gift_recipient>\n"))
